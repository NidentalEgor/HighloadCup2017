...
class DataStorageLoadDataTest
    : public testing::Test
    , public TestDataLoadableTest
{
public:
    DataStorageLoadDataTest()
            : TestDataLoadableTest(test_data_folder_path_)
    {

    }
protected:
    // void LoadData(
    //         const std::string& test_data_folder_name)
    // {
    //     data_storage_->LoadData(test_data_folder_path_ + test_data_folder_name);
    // }

    void AssertEntitiesAmount(
            const size_t entities_amount)
    {
